...
#        self.showMaximized()
        ...
        self.setWindowIcon(QtGui.QIcon('Main_window_icon.png'))
        self.statusBar()
        self.menu()
        self.center()
...
#        self.mean_r_data = None
#        self.median_r_data = None
#        self.median_Filt_data = None
#        self.gauss_Filt_Data = None
#        self.time_pow_data = None
##############################################################################         
    def menu(self):
        ...
        Tool Bars
        """""""""""""""
        extractAction1 = QtWidgets.QAction(QtGui.QIcon('fileopen.png'), 'Open File', self)
        extractAction2 = QtWidgets.QAction(QtGui.QIcon('save.png'), 'Save File', self)
#        extractAction3 = QtWidgets.QAction(QtGui.QIcon('Test3.png'), 'Test', self)
#        extractAction4 = QtWidgets.QAction(QtGui.QIcon('Test4.png'), 'Test', self)   
        ...
        #########
        extractAction1_t2 = QtWidgets.QAction(QtGui.QIcon('Test3.png'), 'Test', self)
        extractAction2_t2 = QtWidgets.QAction(QtGui.QIcon('Test4.png'), 'Test', self)       
